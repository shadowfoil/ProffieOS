...
BladeConfig blades[] = {
 { 0, 
    SubBlade(0, 3, WS281XBladePtr<144, blade2Pin, Color8::GRB, PowerPINS<bladePowerPin2, bladePowerPin3, bladePowerPin5> >()),
    SubBlade(4, 7, NULL),
    SubBlade(8, 8, NULL),
    SubBlade(9, 9, NULL),
    SubBlade(10, 10, NULL),
    SubBlade(11, 143, NULL),
    WS281XBladePtr<10, bladePin, Color8::GRB, PowerPINS<bladePowerPin4> >(),
  CONFIGARRAY(presets) },
};
#endif
